...
public class TableConfig {
    ...
    @Need("true")
    @Attribute("selectByPrimaryKeyQueryId")
    ...
    @Need("true")
    @Attribute("selectByExampleQueryId")
    ...
    */
    ...
    private List<PropertyGenerator> propertyGenerators;

    private List<IgnoreColumn> ignoreColumn;
